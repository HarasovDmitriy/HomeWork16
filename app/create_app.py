...
def create_app():
    ...
    with app.app_context():
        ...
        db.drop_all()
        db.create_all()
        offer = load_offer("/Users/user/PycharmProjects/HomeWork16/data/offers.json")
        user = load_user("/Users/user/PycharmProjects/HomeWork16/data/users.json")
        order = load_order("/Users/user/PycharmProjects/HomeWork16/data/orders.json")
